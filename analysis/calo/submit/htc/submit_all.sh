...
for STREAM in "protons_1TeV_100TeV_E-1" "electrons_1TeV_100TeV_E-1" "protons_10GeV_1000GeV_E-1" #"electrons_10GeV_1000GeV_E-1" 
...
do
	...
	do
	    ...
	    NAME="$BASENAME"
	    LISTFILE=$flist
	    THISOPTS="${OPTS} --parameter pcaCaloAxisTrackingAlgo,edepThreshold,$TH"
       	    echo "$NAME $LISTFILE $THISOPTS"
	    ./submit_one_job.sh $NAME $LISTFILE "$THISOPTS"
	done
    done
done
